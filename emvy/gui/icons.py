...
# cuerpo SVG (sin la envoltura <svg>) por nombre — trazos limpios estilo Lucide.
_PATHS: dict[str, str] = {
    ...
    "flask": '<path d="M10 2v6.1L4.6 17A2 2 0 0 0 6.3 20h11.4a2 2 0 0 0 1.7-3L14 8.1V2"/><path d="M8.5 2h7"/><path d="M7 16h10"/>',
